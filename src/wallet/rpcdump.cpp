...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"rwtalersaddress\"\n"
            "\nReveals the private key corresponding to 'rwtalersaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"rwtalersaddress\"   (string, required) The rwtalers address for the private key\n"
            "\nResult:\n"

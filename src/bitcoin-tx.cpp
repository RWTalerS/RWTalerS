...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s rwtalers-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  rwtalers-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rwtalers transaction") + "\n" +
              "  rwtalers-tx [options] -create [commands]   " + _("Create hex-encoded rwtalers transaction") + "\n" +
              "\n";

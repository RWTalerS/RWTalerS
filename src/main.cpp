...
#if defined(NDEBUG)
# error "RWTalerS cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "RWTalerS Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("rwtalers-scriptch");
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // RWTalerS also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // RWTalerS also requires low S in sigs

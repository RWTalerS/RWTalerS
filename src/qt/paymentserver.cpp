...
const QString BITCOIN_IPC_PREFIX("rwtalers:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/rwtalers-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/rwtalers-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/rwtalers-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click rwtalers: links
...
//
// OSX-specific way of handling rwtalers: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in rwtalers: URIs

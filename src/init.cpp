 ...
 * between rwtalersd, and rwtalers-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/Miner2212/RWTalerS>";
    const std::string URL_WEBSITE = "<http://www.rwtalers.info/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The RWTalerS Developers", 2025)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find RWTalerS useful. "
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("RWTalerS More version %s\n", FormatFullVersion());
}

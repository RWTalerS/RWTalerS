...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The RWTalerS developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "RWTalerS"
...
#define PACKAGE_BUGREPORT "https://github.com/Miner2212/RWTalerS"

/* Define to the full name of this package. */
#define PACKAGE_NAME "RWTalerS"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "RWTalerS 13.2.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "rwtalers"

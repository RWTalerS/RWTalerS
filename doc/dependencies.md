...
These are the dependencies currently used by RWTalerS. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/rwtalersnl
Keybase  - https://keybase.io/team/rwtalers/

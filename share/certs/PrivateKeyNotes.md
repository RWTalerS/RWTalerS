...
unlocked to sign the RWTalerS-Qt.app bundle.
...
allowing somebody to distribute a RWTalerS-Qt.app or rwtalers-qt-setup.exe with a valid
...
that the rwtalers-qt.exe file inside the installer had not been tampered with.
